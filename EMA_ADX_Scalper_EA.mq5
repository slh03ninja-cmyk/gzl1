...
//+------------------------------------------------------------------+
#property copyright "EMA_ADX_Scalper_EA v1.5.3"
...
void OnTick()
  {
   ...
   if(InpUseATR)
     ...
     {
      // 1 pip = 0.01$ de mouvement prix sur XAUUSDm et XAUUSD
      // Verification : 300 pips x 0.01$ = 3.00$ distance
      // Profit = 0.01 lot x 100 oz x 3.00$ = 3.00$ ✅
