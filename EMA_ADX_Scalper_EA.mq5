...
//|                    Expert Advisor - Version 1.3                  |
//|                                                                  |
//|  LOGIQUE IDENTIQUE A L INDICATEUR :                             |
//|                                                                  |
//|  PHASE 1 : ADX <= 10  (consolidation)                           |
//|  PHASE 2 : ADX >  13  (arme - attend croisement)               |
//|  PHASE 3 : Premier croisement ADX/DI EN HAUSSE apres remontee   |
//|    BUY  : ADX croise -DI + ADX en hausse + EMA20>EMA46>EMA200   |
//|    SELL : ADX croise +DI + ADX en hausse + EMA200>EMA46>EMA20   |
//|                                                                  |
//|  PARAMETRES OPTIMAUX (backtest Jan-Mar 2026) :                  |
//|    EMA    : 20 / 46 / 200                                       |
//|    ADX    : periode=20, consolidation<=10, sortie>13            |
//|    SL/TP  : 3000 pips (30$) ratio 1:1                          |
//|    Sessions: 02h-14h + 14h-21h GMT+2 (Asie+Londres+NY)         |
//|                                                                  |
//|  RESULTATS BACKTEST :                                           |
//|    Profit net   : +368.94$ sur 300$ (+123%)                    |
//|    Win Rate     : 67.65%                                        |
//|    Profit Factor: 2.12                                          |
//|    Sharpe Ratio : 15.08                                         |
//|    Drawdown     : 0.00% balance / 13.59% equity                |
//|                                                                  |
//|  GESTION SL/TP EN PIPS :                                        |
//|    1 pip = 0.010$ sur XAUUSDm (2eme decimale)                   |
//|    3000 pips = 30.00$ de distance SL/TP                        |
//+------------------------------------------------------------------+
#property copyright "EMA_ADX_Scalper_EA v1.3"
...
input int    InpSL_Pips      = 3000;   // Stop Loss en pips  (3000 pips = 30.00$)
input int    InpTP_Pips      = 3000;   // Take Profit en pips (3000 pips = 30.00$)
...
input int    InpLondon_Start = 2;    // Ouverture elargie (Asie + Londres)
...
int OnInit()
  {
   ...
   Print("EMA ADX Scalper EA v1.3 initialise | ",
         _Symbol, " | ", EnumToString(Period()),
         " | SL=", InpSL_Pips, "pips (", InpSL_Pips*0.01, "$)",
         " | TP=", InpTP_Pips, "pips (", InpTP_Pips*0.01, "$)");
