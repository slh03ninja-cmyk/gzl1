...
//+------------------------------------------------------------------+
#property copyright "EMA_ADX_Scalper_EA v1.5.2"
...
void OnTick()
  {
   ...
   if(InpUseATR)
     ...
     {
      // XAUUSDm Exness : 1 pip = 0.10$ de mouvement prix
      // Verification : 320 pips x 0.10$ = 32$ distance → profit 32$ avec lot 0.01 ✅
