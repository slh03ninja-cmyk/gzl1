...
//+------------------------------------------------------------------+
#property copyright "EMA_ADX_Scalper_EA v1.5"
...
int OnInit()
  {
   ...
   Print("Sessions: ",
         InpUseAsie    ? "Asie(02-10) " : "",
         InpUseLondres ? "Londres(10-14) " : "",
         InpUseNY      ? "NY(14-21)" : "");
   if(InpUseATR)
   ...
   if(InpUseAsie || InpUseLondres || InpUseNY)
     {
      ...
      int h = dt.hour;
      bool inAsie    = InpUseAsie    && (h >= 2  && h < 10);
      bool inLondres = InpUseLondres && (h >= 10 && h < 14);
      bool inNY      = InpUseNY      && (h >= 14 && h < 21);
